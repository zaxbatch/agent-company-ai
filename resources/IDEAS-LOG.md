# Z-Dot Ideas Log — tracked, not lost
...
| # | Idea | Status | Notes |
|---|------|--------|-------|
| 5 | Snitch-themed mini-game (catch cheese, dodge the cat) → SnowSnakes GAMES | BUILDING | ✅ Goes on SnowSnakes (promo game allowed) |
| 6 | Snitch trailer video | DECLINED | ❌ NOT on SnowSnakes (games only) |

## Content rules (BossLady, confirmed)
- SnowSnakes = GAMES ONLY. Promo games for other projects OK. No episodes/trailers/media pages.

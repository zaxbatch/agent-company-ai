...
- **1-3 games** cadence — CTO has green light to post game ideas anytime; specific games discussed when BossLady ready.
- **6-8 accounts** = TOP PRIORITY. Authentic-looking names, MIXED GENDERS. Mark may have made some already (verify). Everyone can register + post.
- HubSpot CRM works (BossLady set it up) — registrations feed it.
...
- **Meta/Manny**: keep board honest (t2/t20/t21/t22 current).

## Handy links
- Game id 74: https://snowsnakes.zerric.xyz/api/games/74 (Food Truck Frenzy 🎃)
- Game id 76: https://snowsnakes.zerric.xyz/api/games/76 (Snow Snake 🐍)
- Approval folder: resources/snowsnakes/doodles-comics-under-review/

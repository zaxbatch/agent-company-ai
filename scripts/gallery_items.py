...
ITEMS = [
    ...
    dict(id="mu-snowbeats-song", category="MilkUps album", kind="audio",
    ...
    # ---------------- Art ----------------
    dict(id="art-snowbeats", category="Art (doodles)", kind="image",
    ...
    dict(id="art-family", category="Art (doodles)", kind="image",
    ...
    dict(id="art-vin", category="Art (doodles)", kind="image",
    ...
    dict(id="art-q", category="Art (doodles)", kind="image",
    ...
    dict(id="art-manny", category="Art (doodles)", kind="image",
    ...
    dict(id="art-miracle", category="Art (doodles)", kind="image",
         title="Miracle Ayes",
    ...
    dict(id="art-tom", category="Art (doodles)", kind="image",
    ...
    dict(id="art-jr", category="Art (doodles)", kind="image",
    ...
    dict(id="ss-song-12", category="Published on SnowSnakes", kind="audio",
    ...
    dict(id="ss-song-11", category="Published on SnowSnakes", kind="audio",
    ...
    dict(id="ss-doodle-12", category="Published on SnowSnakes", kind="image",
